...
function ChatComponent() {
    ...
    const [currentRole, setCurrentRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('数字能效分析师');
                ...
                try {
                    ...
                    setThinkData({
                        ...
                        parsedContent: parsedContent ? {
                            ...
                            charts: parsedContent.charts?.map({
                                "ChatComponent.useEffect": (chart)=>({
                                        ...chart,
...
_s(ChatComponent, "UTypBMUKR/LrHLWA7OSYQwnOpnE=", false, function() {
    return [
